/* CCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCC
   CCCCCCCCCCCCCCCCCC   MIDACO 5.0 (Limited) MEX FILE   CCCCCCCCCCCCCCCCCC
   CCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCC 
...
{ 
  ...
  if((iflag == 0)&&(istop == 0))
  {
    ...
    for(i=0; i<12; i++) param[i] =  IN_param[i];        
    ...
    tnow  = 0.0;
    tstart = gettime();
    lrw = 105*n+m*P+2*m+o*o+4*o*P+10*o+3*P+1000;    
    liw = 3*n+P+200; 
